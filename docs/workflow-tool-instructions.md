# Workflow tool — model-facing instruction text

> Provenance: this is the verbatim description of the `Workflow` tool as injected into
> Claude's system prompt by Claude Code (captured from a session on CLI ~v2.1.203,
> 2026-07-08). It is the authoritative spec the model follows when writing workflow
> scripts — more complete than the public docs page
> (https://code.claude.com/docs/en/workflows.md). It ships inside the CLI binary and
